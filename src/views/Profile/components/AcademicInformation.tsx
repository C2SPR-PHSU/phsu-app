        ...
        <>
          <Box sx={{ display: "flex", paddingBottom: "1rem", width: "100%" }}>
            ...
            <TextField
              ...
              error={
                formik.touched.entrance_year && !!formik.errors.entrance_year
              }
              helperText={
                formik.touched.entrance_year && formik.errors.entrance_year
              }
          ...
          <Box sx={{ display: "flex", paddingBottom: "1rem", width: "100%" }}>
            ...
            <TextField
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.entrance_terms && !!formik.errors.entrance_terms
              }
              helperText={
                formik.touched.entrance_terms && formik.errors.entrance_terms
              }
